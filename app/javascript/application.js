...
$(document)(function(){
    ...
    $(".exibir_menu").on("click", fn)(function() {
       $(".navbar_mobile").toggle(500);
    });
 
    $(".edit_form").on("click", fn)(function() {
 ...
 $(document).ready(function() {
   $('.info_concedente').trigger("mouseover")(function() {
     $('.rotate_info').show(400);
     $('.div_concedente').show(400);
   });
 
   $('.info_concedente').trigger("mouseleave")(function() {
 ...
 $(document).ready(function() {
   ...
   $('.confirma_preenchimento').trigger("click")(function() {
     $('.confirmacao_preenchimento').slideUp(300);
     $('.clausulas_conteudo').slideUp(300);
   });
 
   $('.avancar').trigger("click")(function() {
     $('.clausulas').show(800);
     $('.clausulas_conteudo').show(800);
     $('.clausulas_conteudo').css("background-color", "rgba(10,10,10,0.6)");
   });
 
   $('.cancelar').trigger("click")(function() {
     $('.clausulas').hide(800);
     $('.clausulas_conteudo').hide(800);
   });
 
   $('.btn1').trigger("mouseover")(function() {
       $('.div_federal').slideDown();
   });
 
   $('.div_federal').trigger("mouseleave")(function() {
       $('.div_federal').slideUp();
   });
 
   $('.btn2').trigger("mouseover")(function() {
       $('.div_federal2').slideDown();
   });
 
   $('.div_federal2').trigger("mouseleave")(function() {
       $('.div_federal2').slideUp();
   });
 
   $('.desaparece_botao').trigger("click")(function() {
