...
ActiveRecord::Schema[7.0].define(version: 2024_08_28_210319) do
  ...
  create_table "relataditivocentros", force: :cascade do |t|
    ...
    t.string "nome_social_termo"
    t.integer "user_id"
    t.index ["user_id"], name: "index_relataditivocentros_on_user_id", unique: true
  end
  ...
  create_table "relatcampis", force: :cascade do |t|
    ...
    t.string "nome_social_termo"
    t.integer "user_id"
    t.index ["user_id"], name: "index_relatcampis_on_user_id", unique: true
  end
